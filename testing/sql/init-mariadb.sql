...
CREATE USER IF NOT EXISTS 'mini_chat_user'@'%' IDENTIFIED BY 'mini_chat_pass';
...
CREATE DATABASE IF NOT EXISTS mini_chat_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
GRANT ALL PRIVILEGES ON mini_chat_db.* TO 'mini_chat_user'@'%';
